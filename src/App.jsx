  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen overflow-hidden flex flex-col">
        <div className="relative z-10 text-left p-4 sm:p-6 md:p-12">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-yellow-400 leading-tight">
            Celebrating <br />
            Visionary <br />
            Filmmaking
          </h1>
          <p className="text-white text-base sm:text-lg mt-4 max-w-2xl px-4">
          ...
          <div className="mt-8 flex flex-wrap gap-4 px-4">
            <img src="/images/Laurel-Design-1.png" alt="Official Selection" className="h-8 sm:h-10 md:h-12" />
            <img src="/images/Laurel-Design-2.png" alt="Quarter-Finalist" className="h-8 sm:h-10 md:h-12" />
            <img src="/images/Laurel-Design-3.png" alt="Semi-Finalist" className="h-8 sm:h-10 md:h-12" />
            <img src="/images/Laurel-Design-4.png" alt="Finalist" className="h-8 sm:h-10 md:h-12" />
            <img src="/images/Laurel-Design-5.png" alt="Winner" className="h-8 sm:h-10 md:h-12" />
          </div>
        </div>
